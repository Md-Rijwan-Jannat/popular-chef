...
const Home = () => {
    ...
    return (
        <div className='grid justify-center'>
            <div className='w-full relative my-1 bg-img' >
            ...
            <div className='flex-col items-center justify-center'>
                <h2 className='text-center text-3xl md:text-4xl lg:text-5xl text-red-600 font-bold my-24'>Chef <span className='text-orange-500 font-normal'>information</span> </h2>
