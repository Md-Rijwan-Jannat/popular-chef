...
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer className="footer p-10 bg-[#F6D155] rounded-t-lg text-base-content">
                <div>
                    <span className="footer-title">Services</span>
                    <a className="link link-hover text-black font-normal">Branding</a>
                    <a className="link link-hover text-black font-normal">Delivery</a>
                    <a className="link link-hover text-black font-normal">Marketing</a>
                    <a className="link link-hover text-black font-normal">Advertisement</a>
                </div>
                <div>
                    <span className="footer-title">Hotel</span>
                    <a className="link link-hover text-black font-normal">About us</a>
                    <a className="link link-hover text-black font-normal">Contact</a>
                    <a className="link link-hover text-black font-normal">Jobs</a>
                    <a className="link link-hover text-black font-normal">Press kit</a>
                </div>
                <div>
                    <span className="footer-title">Location</span>
                    <a className="link link-hover text-black font-normal">Dhaka, 1200-B</a>
                    <a className="link link-hover text-black font-normal">Bogura, SM-12</a>
                    <a className="link link-hover text-black font-normal">Notre, Green valley</a>
                </div>
                <div>
            ...
            <footer className=" footer items-center p-4 bg-base-200 text-neutral-content">
                <div className="items-center grid-flow-col text-red-500 small">
                    ...
                    <p className='text-gray-500 small'>Copyright © 2023 - All right reserved</p>
                </div>
